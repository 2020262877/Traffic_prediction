...
def tree_expansion(uav):
    x = uav.tree[-1][0].x - 0.5
    y = uav.tree[-1][0].y - 0.5
    while not (x == 20.5 and y == 19.5) or (x == 19.5 and y == 20.5) or (x == 19.5 and y == 18.5) or (
            x == 19.5 and y == 19.5):
