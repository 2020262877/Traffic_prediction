...
class Environment(tk.Tk, object):
    def __init__(self):
        ...
        self.title('RL Q-learning based Path planning')
    ...
    def build_environment(self):
        ...
        img_background = Image.open("images/bg2.png")
        ...
        # 为环境设置的障碍
        origin = [(0, 0), (7, 8), (8, 8), (9, 8), (7, 7), (8, 7), (9, 7), (7, 6), (8, 6), (9, 6), (11, 11),
                  (12, 11), (13, 11), (14, 11), (15, 11), (18, 21), (18, 20), (18, 19), (7, 20), (8, 20),
                  (9, 20), (10, 20), (11, 20), (19, 12), (19, 11), (19, 10), (19, 9), (19, 8), (18, 18),
                  (19, 18), (20, 18), (21, 18), (22, 18), (18, 22), (19, 22), (20, 22), (21, 22), (22, 22),
                  (11, 19), (11, 18), (11, 17), (11, 16), (11, 15), (8, 10), (14, 15)]
        ...
        obstacle1_center = self.o + np.array([(origin[1][0] - 1) * pixels, (25 - origin[1][1]) * pixels])
        ...
        obstacle2_center = self.o + np.array([(origin[2][0] - 1) * pixels, (25 - origin[2][1]) * pixels])
        ...
        obstacle3_center = self.o + np.array([(origin[3][0] - 1) * pixels, (25 - origin[3][1]) * pixels])
        ...
        obstacle4_center = self.o + np.array([(origin[4][0] - 1) * pixels, (25 - origin[4][1]) * pixels])
        ...
        obstacle5_center = self.o + np.array([(origin[5][0] - 1) * pixels, (25 - origin[5][1]) * pixels])
        ...
        obstacle6_center = self.o + np.array([(origin[6][0] - 1) * pixels, (25 - origin[6][1]) * pixels])
        ...
        obstacle7_center = self.o + np.array([(origin[7][0] - 1) * pixels, (25 - origin[7][1]) * pixels])
        ...
        obstacle8_center = self.o + np.array([(origin[8][0] - 1) * pixels, (25 - origin[8][1]) * pixels])
        ...
        obstacle9_center = self.o + np.array([(origin[9][0] - 1) * pixels, (25 - origin[9][1]) * pixels])
        ...
        obstacle10_center = self.o + np.array([(origin[10][0] - 1) * pixels, (25 - origin[10][1]) * pixels])
        ...
        obstacle11_center = self.o + np.array([(origin[11][0] - 1) * pixels, (25 - origin[11][1]) * pixels])
        ...
        obstacle12_center = self.o + np.array([(origin[12][0] - 1) * pixels, (25 - origin[12][1]) * pixels])
        ...
        obstacle13_center = self.o + np.array([(origin[13][0] - 1) * pixels, (25 - origin[13][1]) * pixels])
        ...
        obstacle14_center = self.o + np.array([(origin[14][0] - 1) * pixels, (25 - origin[14][1]) * pixels])
        ...
        obstacle15_center = self.o + np.array([(origin[15][0] - 1) * pixels, (25 - origin[15][1]) * pixels])
        ...
        obstacle16_center = self.o + np.array([(origin[16][0] - 1) * pixels, (25 - origin[16][1]) * pixels])
        ...
        obstacle17_center = self.o + np.array([(origin[17][0] - 1) * pixels, (25 - origin[17][1]) * pixels])
        ...
        obstacle18_center = self.o + np.array([(origin[18][0] - 1) * pixels, (25 - origin[18][1]) * pixels])
        ...
        obstacle19_center = self.o + np.array([(origin[19][0] - 1) * pixels, (25 - origin[19][1]) * pixels])
        ...
        # Obstacle 20
        # Defining the center of obstacle 2
        obstacle20_center = self.o + np.array([(origin[20][0] - 1) * pixels, (25 - origin[20][1]) * pixels])
        ...
        obstacle21_center = self.o + np.array([(origin[21][0] - 1) * pixels, (25 - origin[21][1]) * pixels])
        ...
        obstacle22_center = self.o + np.array([(origin[22][0] - 1) * pixels, (25 - origin[22][1]) * pixels])
        ...
        obstacle23_center = self.o + np.array([(origin[23][0] - 1) * pixels, (25 - origin[23][1]) * pixels])
        ...
        obstacle24_center = self.o + np.array([(origin[24][0] - 1) * pixels, (25 - origin[24][1]) * pixels])
        ...
        obstacle25_center = self.o + np.array([(origin[25][0] - 1) * pixels, (25 - origin[25][1]) * pixels])
        ...
        obstacle26_center = self.o + np.array([(origin[26][0] - 1) * pixels, (25 - origin[26][1]) * pixels])
        ...
        obstacle27_center = self.o + np.array([(origin[27][0] - 1) * pixels, (25 - origin[27][1]) * pixels])
        ...
        obstacle28_center = self.o + np.array([(origin[28][0] - 1) * pixels, (25 - origin[28][1]) * pixels])
        ...
        obstacle29_center = self.o + np.array([(origin[29][0] - 1) * pixels, (25 - origin[29][1]) * pixels])
        ...
        obstacle30_center = self.o + np.array([(origin[30][0] - 1) * pixels, (25 - origin[30][1]) * pixels])
        ...
        obstacle31_center = self.o + np.array([(origin[31][0] - 1) * pixels, (25 - origin[31][1]) * pixels])
        ...
        obstacle32_center = self.o + np.array([(origin[32][0] - 1) * pixels, (25 - origin[32][1]) * pixels])
        ...
        obstacle33_center = self.o + np.array([(origin[33][0] - 1) * pixels, (25 - origin[33][1]) * pixels])
        ...
        obstacle34_center = self.o + np.array([(origin[34][0] - 1) * pixels, (25 - origin[34][1]) * pixels])
        ...
        obstacle35_center = self.o + np.array([(origin[35][0] - 1) * pixels, (25 - origin[35][1]) * pixels])
        ...
        obstacle36_center = self.o + np.array([(origin[36][0] - 1) * pixels, (25 - origin[36][1]) * pixels])
        ...
        obstacle37_center = self.o + np.array([(origin[37][0] - 1) * pixels, (25 - origin[37][1]) * pixels])
        ...
        obstacle38_center = self.o + np.array([(origin[38][0] - 1) * pixels, (25 - origin[38][1]) * pixels])
        ...
        obstacle39_center = self.o + np.array([(origin[39][0] - 1) * pixels, (25 - origin[39][1]) * pixels])
        ...
        obstacle40_center = self.o + np.array([(origin[40][0] - 1) * pixels, (25 - origin[40][1]) * pixels])
        ...
        obstacle41_center = self.o + np.array([(origin[41][0] - 1) * pixels, (25 - origin[41][1]) * pixels])
        ...
        obstacle42_center = self.o + np.array([(origin[42][0] - 1) * pixels, (25 - origin[42][1]) * pixels])
        ...
        obstacle43_center = self.o + np.array([(origin[43][0] - 1) * pixels, (25 - origin[43][1]) * pixels])
        ...
        obstacle44_center = self.o + np.array([(origin[44][0] - 1) * pixels, (25 - origin[44][1]) * pixels])
        ...
        # Creating an agent of Mobile Robot - green point
        self.agent = self.canvas_widget.create_oval(
            self.o[0] - 7, self.o[1] - 7 + pixels * 24,
            self.o[0] + 7, self.o[1] + 7 + pixels * 24,
            outline='green', fill='green')

        # Final Point - red rect
        flag_center = self.o + np.array([(end[0] - 1) * pixels, (25 - end[1]) * pixels])
        # Building the flag
    ...
    def final(self):
        ...
        self.initial_point = self.canvas_widget.create_oval(
            self.o[0] - 4, self.o[1] - 4 + pixels * 24,
            self.o[0] + 4, self.o[1] + 4 + pixels * 24,
